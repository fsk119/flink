...
public class ArtifactFetchManager {
    ...
    ArtifactFetchManager(
        ...
        this.baseDir =
                baseDir == null
                        ? new File(conf.get(ArtifactFetchOptions.ARTIFACT_BASE_DIR))
                        : new File(baseDir);
    }
    ...
    public static class Result {
        ...
        private final List<File> additionalJars;

        private Result(@Nullable File jobJar, @Nullable List<File> additionalJars) {
            this.jobJar = jobJar;
            this.additionalJars = additionalJars == null ? Collections.emptyList() : additionalJars;
        }
        ...
        @Nullable
        public File getUserArtifactDir() {
            return additionalJars.isEmpty() ? null : additionalJars.get(0).getParentFile();
        }
    }
}
