...
public class ArtifactFetchOptions {
    ...
    public static final ConfigOption<String> ARTIFACT_BASE_DIR =
            ...
            key("user.artifacts.artifact-list")
                    ...
                    .withDescription(
                            "A semicolon-separated list of the additional artifacts to fetch for the job before setting up the application cluster."
                                    + "All of these have to be valid URIs. Example: s3://sandbox-bucket/format.jar,http://sandbox-server:1234/udf.jar");

    public static final ConfigOption<Map<String, String>> ARTIFACT_HTTP_HEADERS =
