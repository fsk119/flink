...
/**
 * MetadataKafkaDeserializationSchema is used in Table api to extract key, value and metadata from
 * the {@link ConsumerRecord}.
 */
public class MetadataKafkaDeserializationSchema implements KafkaDeserializationSchema<RowData> {
	...
	MetadataKafkaDeserializationSchema(
			...
			MetadataToRowDataConverter[] metadataConverters,
	...
	private static final class MetadataAppendingCollector implements Collector<RowData>, Serializable {
		...
		private final MetadataToRowDataConverter[] metadataConverters;

		private transient ConsumerRecord<?, ?> inputRecord;

		private transient Collector<RowData> outputCollector;

		MetadataAppendingCollector(MetadataToRowDataConverter[] metadataConverters) {
