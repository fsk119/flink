...
public class HelpOperationStrategy implements RegexStrategy {

    public static final HelpOperation INSTANCE = new HelpOperation();

    private static final Pattern PATTERN = Pattern.compile("HELP", DEFAULT_PATTERN_FLAGS);
