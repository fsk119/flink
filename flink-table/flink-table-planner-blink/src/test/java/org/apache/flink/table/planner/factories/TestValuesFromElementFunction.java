...
/**
 * Test class for watermark push down.
 * */
public class TestValuesFromElementFunction implements SourceFunction<RowData> {
	...
	/** History of watermark per record.*/
	public static Collection<Watermark> watermarkHistory = new ArrayList<>();
	...
	public TestValuesFromElementFunction(
	...
	private class TestValuesWatermarkOutput implements WatermarkOutput {
		...
		public void emitWatermark(Watermark watermark) {
			...
			watermarkHistory.add(watermark);
		}
