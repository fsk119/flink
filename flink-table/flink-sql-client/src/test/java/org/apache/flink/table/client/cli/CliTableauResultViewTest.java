...
//    private List<RowDataInfo> data;
//    private List<RowDataInfo> streamingData;
...
//        CliTableauResultView view = new CliTableauResultView(terminal, changelogResult);
//
//        view.displayResults();
//        view.close();
...
//                                + "| boolean |         int |               bigint |
//         varchar | decimal(10, 5) |                  timestamp |              binary |"
//                                + System.lineSeparator()
//                                +
// "+---------+-------------+----------------------+--------------------------------+----------------+----------------------------+---------------------+"
//                                + System.lineSeparator()
//                                + "|  <NULL> |           1 |                    2 |
//             abc |        1.23000 | 2020-03-01 18:39:14.000000 | x'32333485365d737e' |"
//                                + System.lineSeparator()
//                                + "|   FALSE |      <NULL> |                    0 |
//                 |        1.00000 | 2020-03-01 18:39:14.100000 |       x'649e207983' |"
//                                + System.lineSeparator()
//                                + "|    TRUE |  2147483647 |               <NULL> |
//         abcdefg |    12345.00000 | 2020-03-01 18:39:14.120000 |         x'92e90102' |"
//                                + System.lineSeparator()
//                                + "|   FALSE | -2147483648 |  9223372036854775807 |
//          <NULL> |    12345.06789 | 2020-03-01 18:39:14.123000 | x'32333485365d737e' |"
//                                + System.lineSeparator()
//                                + "|    TRUE |         100 | -9223372036854775808 |
//      abcdefg111 |         <NULL> | 2020-03-01 18:39:14.123456 |         x'6e17fffe' |"
//                                + System.lineSeparator()
//                                + "|  <NULL> |          -1 |                   -1 |
// abcdefghijklmnopqrstuvwxyz |   -12345.06789 |                     <NULL> |              <NULL> |"
//                                + System.lineSeparator()
//                                + "|  <NULL> |          -1 |                   -1 |
//    这是一段中文 |   -12345.06789 | 2020-03-04 18:39:14.000000 |   x'fdfeff00010203' |"
//                                + System.lineSeparator()
//                                + "|  <NULL> |          -1 |                   -1 |
// これは日本語をテストするた... |   -12345.06789 | 2020-03-04 18:39:14.000000 |   x'fdfeff00010203' |"
//                                + System.lineSeparator()
//                                +
// "+---------+-------------+----------------------+--------------------------------+----------------+----------------------------+---------------------+"
//                                + System.lineSeparator()
//                                + "8 rows in set"
//                                + System.lineSeparator());
//        assertThat(changelogResult.getNumCancelCalls()).isZero();
//    }
//
//    @Test
...
//                                () ->
//                                        TypedResult.payload(
//                                                streamingData.subList(0, streamingData.size() /
// 2)),
//                                () ->
//                                        TypedResult.payload(
...
//        // character's
//        // width < 2 in IDE by default, every CJK character usually's width is 2, you can open
// this
//        // source file
...
//                                + System.lineSeparator()
//                                + "| +I |  <NULL> |           1 |                    2 |
//                  abc |        1.23000 | 2020-03-01 18:39:14.000000 |
// x'32333485365d737e' |"
//                                + System.lineSeparator()
//                                + "| -U |   FALSE |      <NULL> |                    0 |
//                      |        1.00000 | 2020-03-01 18:39:14.100000 |
// x'649e207983' |"
//                                + System.lineSeparator()
//                                + "| +U |    TRUE |  2147483647 |               <NULL> |
//              abcdefg |    12345.00000 | 2020-03-01 18:39:14.120000 |
// x'92e90102' |"
//                                + System.lineSeparator()
//                                + "| -D |   FALSE | -2147483648 |  9223372036854775807 |
//               <NULL> |    12345.06789 | 2020-03-01 18:39:14.123000 |
// x'32333485365d737e' |"
//                                + System.lineSeparator()
//                                + "| +I |    TRUE |         100 | -9223372036854775808 |
...
//                                TypedResult<List<RowDataInfo>>, SqlExecutionException>>
//                resultChanges;
//
//        private int numRetrieveResultPageCalls = 0;
//        //        private final List<SupplierWithException<List<RowDataInfo>,
//        // SqlExecutionException>> resultPages;
//
//        public TestChangelogResult(
//                List<SupplierWithException<TypedResult<List<RowDataInfo>>, SqlExecutionException>>
//                        resultChanges) {
...
//
//        @Override
//        public TypedResult<List<RowDataInfo>> retrieveChanges() {
