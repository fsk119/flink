 ...
 * {@link BinaryRowData}, every field (including both fixed-length part and variable-length part) of
 * {@link NestedRowData} has a possibility to cross the boundary of a segment, while the
 * fixed-length part of {@link BinaryRowData} must fit into its first memory segment.
 */
@Internal
